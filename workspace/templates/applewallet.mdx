...
An Apple Wallet Template generates dynamic digital business cards, personalized with each user’s details when downloaded. These Wallet Cards display the user’s name, job title, and your company branding, and when scanned, link directly to the user’s Tapify Profile for seamless sharing.
...
3. Select **Apple Wallet Business Card**\*.\*

### Branding

You can customize the Apple Wallet business card template to align it to your company's branding:
