...
Before sending invites to your users make sure everything in your workspace is setup correctly, learn more in the [Get](https://docs.tapify.app/introduction#getting-started)[ting started](https://docs.tapify.app/introduction#getting-started).
